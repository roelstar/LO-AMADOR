...
# ESPACIO ENTRE LOS LOGOS Y LA FRASE
ESPACIO_FRASE = 30
...
# POSICIÓN VERTICAL DEL ENCABEZADO
MARGEN_ARRIBA = 0
...
# ============================================================
# COLUMNA 1
# AUTECO | TU EXPERIENCIA NOS IMPORTA | DISMERCA
# ============================================================

with col1:

    # --------------------------------------------------------
    # Convertir logos a Base64 para poder usarlos en HTML
    # --------------------------------------------------------
    ...
    st.markdown(
        ...
        <div style="
            ...
            gap:{ESPACIO_FRASE}px;
            margin-top:{MARGEN_ARRIBA}px;
            white-space:nowrap;
        ">
            ...
            <!-- FRASE -->
            <div style="
                font-size:{TAMANO_FRASE}px;
                font-weight:{NEGRILLA_FRASE};
                color:{COLOR_FRASE};
                text-align:center;
                line-height:1.15;
            ">
